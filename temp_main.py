...
parser.add_argument('-e', dest="epoch_number", default=30, help="Number of Epochs")
...
parser.add_argument('-disjoint_transductive_inductive', dest="disjoint_transductive_inductive", default= True , help="This flag is used for sampling methods")
    ...
    for i in sample_list:
        ...
        if single_link:
            ...
            for nn in org_adj[idd].nonzero()[0]:
                ...
                get_matrices(test_edges, test_edges_false, org_adj, re_adj_prior, auc_list_single, val_acc_list_single, val_ap_list_single, precision_list_single,recall_list_single)
                if prior_only:
        ...
        if multi_link:
            ...
            adj_list_copy[:, idd] = 0 # set all the neigbours to 0
            std_z_prior , m_z_prior , z_prior , re_adj_prior = run_network(features_kdd, adj_list_copy, inductive_pn, is_prior = True)
            get_matrices(test_edges, test_edges_false, org_adj, re_adj_prior, auc_list_multi , val_acc_list_multi , val_ap_list_multi , precision_list_multi ,recall_list_multi )
